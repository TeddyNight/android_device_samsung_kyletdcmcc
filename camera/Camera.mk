...
LOCAL_C_INCLUDES := \
	...
	$(TOP)/kernel/samsung/kyletdcmcc/include/video \
	$(TOP)/device/samsung/kyletdcmcc/gralloc
...
LOCAL_CFLAGS := -fno-strict-aliasing -D_VSP_ -DJPEG_ENC -D_VSP_LINUX_ -DCHIP_ENDIAN_LITTLE -DCONFIG_CAMERA_3M  -DANDROID_4100

ifeq ($(strip $(TARGET_BOARD_PLATFORM)),sc8810)
LOCAL_CFLAGS += -DCONFIG_CAMERA_3M
endif
